...
/* On peut ajouter un écouteur d'évènement à un élément selectionné via la 
méthode (fonction) addEventListener.
Le premier argument est le type de l'évènement, le second est une fonction callback 
...
// On peut donner en fonction callback, une fonction définie ailleurs comme 
...
pa.addEventListener("click", (e)=>{
    ...
    que l'évènement (ici click) devrait déclenché, sont ignoré.*/
    e.stopPropagation();
    console.log("pa")
});
